...
list_stations = ['SN05',  'SN07', 'SN11', 'SN12', 'SN13', 'SN14']
t1 = t0 + tdur

st = opy.read('/Volumes/LaCie/SN_Thesis/Day177/8G.Array..HHZ.2018.onset_tremor.Decon.mseed')
...
plt.plot(np.linspace(0, duration_min, nwin)/60, spectral_width_average, "r")
