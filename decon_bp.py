...
def deconvolve_prefilt(st):
    ...
    for tr in st:
        ...
        st_d = tr.remove_response(inventory=inventory, pre_filt=pre_filt, output='VEL')#removes response
        st_d.detrend('demean')
        st_decon.append(st_d)
        print('Done with ' + stats.station)
    file_name = '/Volumes/LaCie/SN_Thesis/Day177/8G.Array..HHZ.2018.177.BP3.Decon.mseed'
    print(file_name)
...
# pre_filt3 = [0.5, 0.7, 17, 20]
# pre_filt2 = [0.001, 0.01, 40, 45]
